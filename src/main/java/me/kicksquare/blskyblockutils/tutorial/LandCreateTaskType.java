...
public class LandCreateTaskType extends BukkitTaskType {
    private BLSkyblockUtils plugin;

    public LandCreateTaskType(BLSkyblockUtils blSkyblockUtils) {
        super("landcreate", "kicksquare", "create a LANDS Land");
    ...
    public void landCreated(LandCreateEvent event) {
